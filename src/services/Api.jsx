...
export async function getCurrentWeather({ city }) {
    ...
    const { data } = await clientWeather(`/forecast?latitude=${latitude}&longitude=${longitude}&current=temperature_2m,relative_humidity_2m,cloud_cover,wind_speed_10m,weather_code&hourly=temperature_2m,precipitation_probability,weather_code&forecast_days=1&daily=sunrise,sunset&timezone=auto`);
